...
This is achieved by making it easy for developers to spin up the standard image to run their builds, allowing them to [easily produce the same result](/model/cards/on-demand-environments/ "Access to production-like environments") as the toll gate job.
...
It simply vanishes. Please refer to the [architecture cards](/model/areas/arch/#tag "Architecture & Design") for more information.
